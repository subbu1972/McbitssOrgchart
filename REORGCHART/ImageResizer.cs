...
namespace REORGCHART
{
    public class ImageResizer
    {
        ...
        public void SaveJpeg(string path, Image img)
        {
        ...
        public void Save(string path, Image img, ImageCodecInfo imageCodecInfo)
        {
            var qualityParam = new EncoderParameter(Encoder.Quality, 100L);
        ...
        /// <param name="height">canvas height</param>  
        /// <returns></returns>  
        public Image PutOnWhiteCanvas(Image image, int width, int height)
        {
