    ...
    $.ajax({
        ...
        success: function (json) {
            ...
            $.each(OrgData, function (key, item) {
                ...
                LI += "<li class=\"ui-state-default\" data-id=\"" + item.LEVEL_ID + "\" data-parent=\"" + item.PARENT_LEVEL_ID + "\"><span class=\"ui-icon ui-icon-arrowthick-2-n-s\"></span><div style=\"display: inline-block!important;word-break: break-all!important;font-size:12px!important;\">" + Caption + "</div></li>";
            });
            $("#sortable").html(LI);
            $(".overlay").hide();
